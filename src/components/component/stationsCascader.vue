...
<template>
  <section>
    ...
    <div class='demo-block demo-zh-CN demo-select'>
      <div class='source'>
        <stationsCascader ref='stationsCascader' v-model='value'></stationsCascader>
      </div>
      <div class='meta' style='height: auto'>
        <div class='description'>
          <p>组件中使用 <code>v-model</code>, 还需要引入 <code>DCity/queryCityTreeByParent</code>, <code>DStation/query</code>, <code>DCity/queryCityList</code></p>
        </div>
        <div class='highlight'>
          <pre>
