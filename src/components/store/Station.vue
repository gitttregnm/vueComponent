...
export default {
  ...
  data () {
    return {
      ...
      tableData1: [
        {
          propName: 'stationType',
          explain: '字典，站点类型转为显示用站点类型',
          defaultValue: store.state.station.stationType
        }
      ],
      tableData2ByProp: [
        // {
        //   propName: 'topMenu',
        //   explain: '一级菜单组',
        //   defaultValue: store.getters['safeguardPlan/topMenu']
        // }
      ],
      tableData2ByFunction: [
        {
          propName: 'getNameByStationType',
          explain: '通过站点类型获取显示用站点类型',
          param: 'type',
          returnValue: '显示用站点类型'
        }
      ],
