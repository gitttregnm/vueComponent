...
<template>
  <section>
    ...
    <h2>AreaCascader2 城市级联选择器(懒加载)</h2>

    <h3></h3>

    <p>适用广泛的基础城市级联选择器(懒加载)</p>

    <div class="demo-block demo-zh-CN demo-select">
      <div class="source">
        <AreaCascader2 v-model="value"></AreaCascader2>
      </div>
      <div class="meta" style="height: auto">
        <div class="description">
          <p>组件中只有已加载的数据，所以无法搜索</p>
        </div>
        <div class="highlight">
          <pre>
...
<script>
// import
import AreaCascader2 from '@/componentsAreaCascader'
import hljs from 'highlight.js'
export default {
  name: 'AreaCascader2Dom',
  mixins: [],
  data () {
    return {
      // 定义的每个data 属性必须有注释
      ...
      tableData1: [
        {
          ...
          explain: '绑定值',
          type: 'Array',
          optionalValue: '城市code',
          defaultValue: ''
        },
        {
          parameter: 'maxLevel',
          explain: '级联级别，不是城市级别（值为 1 时，省级的直接区县子级也会显示）',
          type: 'Number',
          optionalValue: '0-3',
          defaultValue: '3'
        },
      ...
      tableData3: [
        ...
        // },
        {
          method: 'getAreaByCode',
          parameter: 'code',
          explain: '通过 code 获取区域完整信息',
          returnValue: 'option（code 对应的区域完整信息） || \'\''
        }
      ]
    }
  },
